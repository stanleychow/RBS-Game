...
while running:
    ...
    #Winning/losing and bullet logic
    if user_ammo > 0:
        pygame.draw.circle(screen, GREEN, (150, 400), 30, 0)
    if user_ammo > 1:
        pygame.draw.circle(screen, GREEN, (300, 400), 30, 0)
    if user_ammo > 2 and user_life == 1:
        pygame.draw.circle(screen, GREEN, (450, 400), 30, 0)
        font = pygame.font.SysFont(None, 40)
        img = font.render('You Won!', True, GREEN)
        screen.blit(img, (50, 50))
    if user_ammo > 2 and user_life == 0:
        pygame.draw.circle(screen, GREEN, (450, 400), 30, 0)
        font = pygame.font.SysFont(None, 40)
        img = font.render('Tie Game!', True, GREEN)
        screen.blit(img, (50, 50))

    if computer_ammo > 0:
        pygame.draw.circle(screen, RED, (150, 200), 30, 0)
    if computer_ammo > 1:
        pygame.draw.circle(screen, RED, (300, 200), 30, 0)
    if computer_ammo > 2 and computer_life == 1:
        pygame.draw.circle(screen, RED, (450, 200), 30, 0)
        font = pygame.font.SysFont(None, 40)
    ...
    if computer_life == 0 and user_life > 0:
        font = pygame.font.SysFont(None, 40)
        img = font.render('You Won!', True, GREEN)
        screen.blit(img, (50, 50))
    if user_life == 0 and computer_life > 0:
        font = pygame.font.SysFont(None, 40)
        img = font.render('You Lost!', True, RED)
        screen.blit(img, (50, 50))
    if computer_life == 0 and user_life == 0:
